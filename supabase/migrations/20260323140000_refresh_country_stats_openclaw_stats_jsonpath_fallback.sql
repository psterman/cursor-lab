-- OpenClaw 指标：除 stats.openclaw.stats 外，回退读取 stats.openclaw_stats（与 Worker 解析逻辑一致）
...
comment on column public.country_stats_current.lobster_metrics is 'OpenClaw：messages, tool_calls, tasks_executed；源路径 stats.openclaw.stats 与 stats.openclaw_stats';
